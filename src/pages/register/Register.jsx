...
const Register = () => {
  ...
  return (
    <div className='register w-full min-h-screen bg-slate-100 flex items-center justify-center max-sm:px-[50px] sm:px-[30px] lg:px-0'>
      <div className=''>
        <h1 className=' text-center hidden max-sm:block text-3xl max-md:text-2xl font-lobster font-medium'>Welcome To Vacation</h1>
        <div className="card mt-4 flex lg:w-2/3  mx-auto rounded-md  overflow-hidden max-sm:w-full  max-sm:h-[500px] max-sm:items-center max-sm:justify-center sm:w-full">
          <div className="left border border-slate-950 flex-1 flex flex-col gap-[30px] justify-between px-[30px] py-[20px] max-sm:hidden">
            <h1 className='text-slate-100 font-lobster lg:text-2xl sm:text-2xl whitespace-nowrap'>Welcome To Vacation.</h1>
            ...
            <div>
              ...
              <Link to="/login"><button className='border w-2/3 py-1 text-xl text-slate-100 font-lobster tracking-widest rounded-sm hover:bg-slate-900 hover:border-slate-900 border-b sm:text-sm sm:py-2 lg:text-[20px] mt-4'>Login</button></Link>
            </div>
          </div>
          <div className="right flex-1 flex flex-col bg-white px-[50px] py-[20px] max-sm:h-full ">
            ...
            <form encType='multipart/form-data' className='flex flex-1 flex-col justify-between' onSubmit={RegisterUser}>
              ...
              <label htmlFor="file" className='flex w-fit items-center text-sm gap-1 cursor-pointer  mb-2' >
                ...
                <h1 className=' font-medium underline whitespace-nowrap'>Upload avatar</h1>
              </label>
