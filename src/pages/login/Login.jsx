    ...
    <div className='login relative w-full min-h-screen bg-slate-100 flex items-center justify-center max-sm:px-[50px] sm:px-[30px] lg:px-0'>
      <div className=''>
        ...
        <div className="card mt-4 flex lg:w-2/3  mx-auto rounded-md  overflow-hidden max-sm:w-full max-sm:items-center max-sm:justify-center sm:w-full">
          <div className="left flex-1 flex flex-col gap-[10] px-[50px] py-[20px] max-sm:hidden">
          ...
          <div className="right flex-1 flex flex-col bg-white px-[50px] pb-[25px] pt-[60px] max-sm:h-[350px]">
            { errorMessage &&
