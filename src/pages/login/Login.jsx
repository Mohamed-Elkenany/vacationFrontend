        ...
        <div className="card mt-4 flex lg:w-2/3  mx-auto rounded-md  overflow-hidden max-sm:w-full max-sm:items-center max-sm:justify-center sm:w-full">
          ...
          <div className='h-full w-full flex flex-col'>
            <form className='flex flex-1 flex-col justify-between' onSubmit={handleLogin}>
              ...
              <button disabled={isLoading || !email || !password} className='border border-slate-900 py-1 w-1/2 mx-auto text-xl font-lobster rounded-sm hover:bg-slate-900 hover:text-slate-100 sm:text-sm sm:py-2 lg:text-[25px]'>Login</button>
            </form>
