...
import { useGetUserByIdMutation, useGetPostProfileMutation } from "../../slices/appApiSlice";
...
const UserInfo = ({ suggestConsumer }) => {
  ...
  return (
    <Link to={`/profile/${userId}`} className='relative w-full flex-1 h-1/2 bg-white dark:bg-gray-800 rounded-md shadow-md flex flex-col justify-between'>
